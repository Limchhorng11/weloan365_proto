  ...
  recommendations: [
    {
      ...
      reasoning:
        "Your steady salary deposits qualify you for our fastest-track micro loan.",
    },
    {
      productId: "p4",
      name: "Housing Loan (HL)",
      tagline: "Lowest rate · longest tenor",
      icon: "home",
    ...
    },
    {
      ...
      tagline: "Pre-departure financing",
      icon: "plane",
      ...
      isLocked: false,
      reasoning:
        "Covers placement, visa and flight costs; repayments aligned with overseas salary.",
    },
  ],
};
