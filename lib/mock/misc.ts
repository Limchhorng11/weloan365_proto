...
export const notifications: NotificationItem[] = [
  {
    ...
    body: "Your Motorbike Loan installment of $162.50 is due in 3 days.",
    time: "2h ago",
    unread: true,
    category: "payment",
  },
  {
    ...
    icon: "check-circle",
    title: "Loan Approved",
    body: "Your Education Loan of $8,000 has been approved. Funds will be disbursed within 24 hours.",
    time: "1 day ago",
    unread: true,
    category: "loan",
  },
