...
export const promos: Promo[] = [
  {
    id: "edu-low-rate",
    title: "Housing Loan 0.75%",
    shortDesc: "Lowest rate this quarter",
    longDesc:
      "Own your home without breaking the bank. For a limited time, our Housing Loan (HL) rate drops to just 0.75% per month — the lowest we've ever offered.",
    cta: "Apply for Housing Loan",
    ctaHref: "/loan/products/p4/request",
    gradient: "linear-gradient(135deg, #ff6b9d, #c2185b)",
    highlight: "0.75% / mo",
    validUntil: "Jun 30, 2026",
    terms: [
      "Available for first-time home buyers and renovations",
  ...
  {
    id: "biz-fast-track",
    title: "SBL fast-track approval",
    shortDesc: "Approval in 24 hours",
    longDesc:
      "For verified small businesses, our Small Business Loan (SBL) can be reviewed and disbursed within 24 hours. Get the working capital you need without the wait.",
    cta: "Apply for Small Business Loan",
    ...
    terms: [
      "Available for registered businesses with 6+ months of history",
