...
const QUICK_LINK_GROUPS: { title: string; links: QuickLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Restructure payment (l3)", href: "/my-loan/approved/l3/restructure" },
      ...
      { label: "Restructure payment (overdue l7)", href: "/my-loan/approved/l7/restructure" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "AI Loan Health Scoring", href: "/more/ai-score" },
      { label: "Credit & Insights", href: "/more/insights" },
      { label: "Income Assessment", href: "/more/income-assessment" },
      ...
      { label: "FAQ Center", href: "/more/faq" },
