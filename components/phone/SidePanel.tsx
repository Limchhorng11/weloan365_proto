...
const QUICK_LINK_GROUPS: { title: string; links: QuickLink[] }[] = [
  {
    ...
    links: [
      ...
      { label: "Sign In — Account", href: "/sign-in", flowRef: "1.F2" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Repayment Schedule", href: "/my-loan/approved/l3/repayment" },
      { label: "Payment History", href: "/my-loan/approved/l3/history", flowRef: "3.F2" },
